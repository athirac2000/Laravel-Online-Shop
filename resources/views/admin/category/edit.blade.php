						...
						<div class="card">
							<div class="card-body">								
								<div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <!-- if we make input type hidden , we will get the image id and can store it along with category details and at the same time it doesnt get showed up in the screen -->
                                            <input type="hidden" id="image_id" name="image_id" valuue="">
                                        ...
                                        <div >
                                            ...
                                            <img src="{{asset('uploads/category/'.$category->image)}}" alt="" height="250px" width="250px">
                                        </div>
                                        @endif
                                    </div>									
									<div class="col-md-6">
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response['notFound'] == true){
                    window.location.href="{{route('categories.index')}}"; //this means the record is not present(database) 
                }
